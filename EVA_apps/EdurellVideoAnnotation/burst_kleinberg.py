...
def kleinberg(offsets: list, s: float, gamma: float) -> np.array:
    ...
    :param offsets: (list) a list of indexes of the sentences where the word appears (must be non-empty)
    ...
    :return: bursts (a numpy array containing all the intervals of burst)
    """
