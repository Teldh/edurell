    ...
    if form.validate_on_submit():
        ...
        try:
            ...
            if segmentation_data is None:
                ...
                if vid_analyzer.is_slide_video(return_slide_frames=False):
                ...
                video_slidishness = segmentation_data['video_slidishness']
                slide_startends = segmentation_data['slide_startends']
                vid_analyzer.set(video_slidishness,slide_startends)
    ...
    if syn_burst:
        ...
        if burstType == 'video':
            try:
                ...
                if vid_analyzer.is_slide_video(return_slide_frames=False):
                    vid_analyzer.set(titles=segmentation_data['slide_titles'])
                    # If I find my title with def and indepth inside defs_and_indepths then I adjust the times
                    # If I don't find it, I add it in the same format as defs_and_indepths
                    # I ignore concept_map
