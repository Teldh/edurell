...
def video_selection():
    ...
    if form.validate_on_submit():
        ...
        try:
            ...
            segmentator = VideoAnalyzer(vid_id)
            subtitles, autogenerated = segmentator.get_transcript()
            # segment the video with semantic similarity
            #TODO can be optimized using the already analyzed video for the slide classification
            # need to swap lemmatization and keyframes extraction
